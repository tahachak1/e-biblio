...
export function AdminDashboard() {
  const { adminStats, setCurrentPage } = useApp();
  ...
  const miniVentes = salesData.map((d) => d.ventes);
  const miniLocations = salesData.map((d) => d.locations);
      ...
      <div className="max-w-[1216px] mx-auto px-4 sm:px-6 lg:px-6 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="rounded-2xl border border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-1">
              <div className="text-2xl font-semibold text-slate-900">
                {adminStats.totalVentes?.toLocaleString("fr-FR")} €
              </div>
          ...
          <Card className="rounded-2xl border border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-1">
              <div className="text-2xl font-semibold text-slate-900">{adminStats.locationsActives}</div>
              <p className="text-xs text-slate-600">
          ...
          <Card className="rounded-2xl border border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-1">
              <div className="text-2xl font-semibold text-red-600">{adminStats.retards}</div>
          ...
          <Card className="rounded-2xl border border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-1">
              ...
              <p className="text-xs text-slate-600">
                <span className="text-green-600 font-semibold">+18%</span> vs hier
              </p>
            </CardContent>
          </Card>
        </div>
