  ...
  export default defineConfig({
    ...
    resolve: {
      ...
      alias: {
        ...
        data: path.resolve(__dirname, './src/admin/data'),
        helpers: path.resolve(__dirname, './src/admin/helpers'),
        layouts: path.resolve(__dirname, './src/admin/layouts'),
        providers: path.resolve(__dirname, './src/admin/providers'),
