...
import { CustomerFulfillmentProps, customerFulfillmentData } from 'data/chart-data/customer-fulfillment';

const CustomerFulfillment = ({ data }: { data?: CustomerFulfillmentProps }): ReactElement => {
  const theme = useTheme();
  const chartRef = useRef<EChartsReactCore | null>(null);
  const chartData = data ?? customerFulfillmentData;
      ...
      >
        <Stack gap={1.25} alignItems="center">
          ...
          <Typography variant="body2" color="common.white">
            {getTotalFulfillment(chartData['This Month'])}
          </Typography>
        </Stack>
        <Stack gap={1.25} alignItems="center">
          <Button
          ...
          <Typography variant="body2" color="common.white">
            {getTotalFulfillment(chartData['Last Month'])}
          </Typography>
        </Stack>
      </Stack>
    </Paper>
