...
const EarningsChart = ({ chartRef, value = 80, ...rest }: EarningsChartProps): ReactElement => {
  ...
  const option: EarningsChartOptions = useMemo(
    ...
    [value, theme.palette.common.white, theme.palette.grey, theme.palette.primary.main],
  );
